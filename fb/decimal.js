...
import BigNumber from "./decimal.js"        // es6
...
// number of significant digits and rounding mode
Decimal.set({ precision: 5, rounding: 4 })              // set for default constructor
Decimal9 = Decimal.clone({ precision: 9, rounding: 1 }) // create another constructor
x = new Decimal(5)
y = new Decimal9(5)
x.div(3)                                    // '1.6667'
y.div(3)                                    // '1.66666666'
