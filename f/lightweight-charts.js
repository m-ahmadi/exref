...
iSeriesApi = chart['add'+'Area|Bar|Baseline|Candlestick|Histogram|Line'+'Series']()
iSeriesApi.priceFormatter()
iSeriesApi.priceToCoordinate(price=0)
iSeriesApi.coordinateToPrice(coordinate=0)
iSeriesApi.barsInLogicalRange(range=[0,..])
iSeriesApi.applyOptions(options)
iSeriesApi.options()
iSeriesApi.priceScale()
iSeriesApi.setData(data)
iSeriesApi.update(bar)
iSeriesApi.dataByIndex(logicalIndex, ?mismatchDirection)
iSeriesApi.setMarkers(data)
iSeriesApi.markers()
iSeriesApi.createPriceLine(options)
iSeriesApi.removePriceLine(line)
