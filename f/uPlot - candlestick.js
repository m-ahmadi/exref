...
const opts = {
	...
	series: [
		{label: 'Date',   value: (u,ts) => fmtDate(tzDate(ts))},
		{label: 'Open',   value: (u,v) => fmtUSD(v, 2)},
		{label: 'High',   value: (u,v) => fmtUSD(v, 2)},
		{label: 'Low',    value: (u,v) => fmtUSD(v, 2)},
		{label: 'Close',  value: (u,v) => fmtUSD(v, 2)},
