...
<p disabled></button>           ...
<p type=checkbox />             ...
<p href="page/{p}">page {p}</p> value can contain expressions
<p disabled={!clickable} />     or be             expressions
<p required={false} />          boolean attr included if truthy, excluded if falsy  (not required)
