...
reduction = tf.keras.losses.Reduction. AUTO|SUM_OVER_BATCH_SIZE|SUM|NONE

tf.keras.losses.
	Loss(reduction, name=None)
		.call(y_true, y_pred)
		.from_config(config)
		.get_config()
		__call__(y_true, y_pred, ?sample_weight=None)
	BinaryCrossentropy(from_logits=False, label_smoothing=0, axis=-1, reduction, name='binary_crossentropy')
	CategoricalCrossentropy(from_logits=False, label_smoothing=0, axis=-1, reduction, name='categorical_crossentropy')
	CategoricalHinge(reduction, name='categorical_hinge')
	CosineSimilarity(axis=-1, reduction, name='cosine_similarity')
	Hinge(reduction, name='hinge')
	Huber(delta=1.0, reduction, name='huber_loss')
	KLDivergence(reduction, name='kl_divergence|kullback_leibler_divergence|kld|KLD')
	LogCosh(reduction, name='log_cosh|logcosh')
	MeanAbsoluteError(reduction, name='mean_absolute_error|mae|MAE')
	MeanAbsolutePercentageError(reduction, name='mean_absolute_percentage_error|mape|MAPE')
	MeanSquaredError(reduction, name='mean_squared_error|mse|MSE')
	MeanSquaredLogarithmicError(reduction, name='mean_squared_logarithmic_error|msle|MSLE')
	Poisson(reduction, name='poisson')
	SparseCategoricalCrossentropy(from_logits=False, reduction, name='sparse_categorical_crossentropy')
	SquaredHinge(reduction, name='squared_hinge')
