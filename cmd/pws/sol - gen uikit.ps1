...
wget 'https://raw.githubusercontent.com/m-ahmadi/exref/master/html/base.htm' -OutFile index.html
(gc index.html) `
	-replace '(<link rel="stylesheet".*href=")', '$1css/style.css' `
	-replace '(<script.*src=")', '$1js/main.js' |
		Out-File index.html

wget 'https://github.com/uikit/uikit/releases/download/v3.2.7/uikit-3.2.7.zip' -OutFile file.zip
